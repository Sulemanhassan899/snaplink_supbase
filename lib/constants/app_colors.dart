...
const kWhite2 = Color.fromARGB(28, 255, 255, 255);
const kBlack = Color(0xFF000000);
const kPrimaryColor = Color(0xFFAE0AC9);
const kSecondaryColor = Color(0xFF3B2F39);
...
const kredColor = Color(0xFFF23F3F);
...
const kbackground = Color(0xFFF9F9FE);
...
const kTexfeildGradeintColor2 = LinearGradient(
  ...
  colors: [const Color(0xFF6431FA), const Color(0xFFDEA0E3)],
);
